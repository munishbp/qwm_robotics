...
| [docs/related_work.md](docs/related_work.md) | Each claim placed against prior work |
| [docs/reviews/](docs/reviews/) | Second round NeurIPS style reviews from three skeptics and the meta review (first round in git history) |
